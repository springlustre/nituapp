...
Page({
    ...
    receiveMsg: function (msg, type) {
        var that = this
        var myName = wx.getStorageSync('myUsername')
        console.log(msg.to +"=="+ that.data.groupId)
        if (msg.to == that.data.groupId || msg.from == that.data.yourname || msg.to == that.data.yourname) {
            //console.log(msg)
            if (type == 'txt') {
            ...
            console.log("-+_+_+_"+msg.to+" "+that.data.groupId)
            if (msg.from == that.data.yourname) {
                msgData.style = ''
                msgData.username = msg.from
            } else if(msg.to == that.data.groupId){
                msgData.style = ''
                msgData.username = msg.from
            }else{
                msgData.style = 'self'
